<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column label="No." type="index" align="center" width="auto" min-width="10%">
      ...
      <el-table-column label="Quantity" width="auto" align="center" min-width="15%">
        <template slot-scope="{row}">
      ...
      <el-table-column label="Unit price" width="auto" align="left" min-width="10%">
        <template slot-scope="{row}">
          <span>{{ row.price }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="Actions" align="center" width="auto" class-name="small-padding fixed-width" min-width="15%">
    ...
    <el-col :span="6" :offset="15">
      <el-form-item label="Subtotal">
        <el-input type="text" v-model="subtotal" :disabled="true" style="width:100px"/>
      </el-form-item>
    </el-col>
    ...
    <!-- Dialog -->
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible"   :close-on-click-modal="false" :before-close="closeDialog">
      ...
      label-width="90px" style="margin-left:20px; margin-right:40px">
        <el-form-item label="Product" prop="productname"> 
          <el-cascader :options="optionedItme" 
          @change="handleOptionChange"
          v-model="tempOption"
          style="width:260px; margin-bottom:20px" ></el-cascader>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" v-if="dialogStatus === 'Add'" @click="addItem()">
          Add
        </el-button> 
        <el-button type="primary" v-if="dialogStatus === 'Edit'" @click="editItem()">
          Confirm
        </el-button>
      </div>
